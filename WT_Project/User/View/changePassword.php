...
<div class="main">
    ...
    <div class="main-content">
        <div class="info-box">
            <b>Update Password</b>
            <hr>
        <form method="post" action="/WT_Project/User/Controller/handleUpdatePassword.php">
            <p>Current Password : <input type="password" name="currentPassword" placeholder="Current password" required></p>
            <p>New Password &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <input type="password" name="newPassword" placeholder="New password" required></p>
            <p>Confirm Password : <input type="password" name="confirmPassword" placeholder="Confirm password" required></p>
            <p style="color:red;">
                <?php echo $passErr; ?>
            </p>
