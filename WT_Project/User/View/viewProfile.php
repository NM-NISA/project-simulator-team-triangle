...
<div class="main">
    ...
    <div class="main-content">
        <div class="info-box">
            <b>Profile</b>
            <hr>
            <form method="POST" action="/WT_Project/User/View/deleteProfile.php" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete your profile? This cannot be undone!');">
                <p>Name &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <span name="name"><?php echo htmlspecialchars($name); ?></span></p>
                <p>Email &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;: <span name="email"><?php echo htmlspecialchars($email); ?></span></p>
                <p>Phone No. &nbsp;&nbsp;&nbsp;&nbsp;: <span name="phone"><?php echo htmlspecialchars($phone); ?></span></p>
                <p>Logged in as : <span name="user"><?php echo htmlspecialchars($userType); ?></span></p>
                <a class="btn" href="/WT_Project/User/View/editProfile.php">Edit Profile</a>
                <a class="btn" href="/WT_Project/User/View/changePassword.php">Change Password</a>
                <button type="submit" class="del">Delete Profile</button>
                <?php if ($passSuccess): ?>
                <script>
                    alert("<?php echo addslashes($passSuccess); ?>");
                </script>
                <?php endif; ?>
            </form>
        </div>
